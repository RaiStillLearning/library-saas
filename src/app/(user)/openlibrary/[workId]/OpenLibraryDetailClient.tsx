...
import {
  ...
  Calendar, ChevronDown, ChevronUp, List, CheckCircle,
...
interface OpenLibraryDetailClientProps {
  workId: string;
}

export default function OpenLibraryDetailClient({ workId }: OpenLibraryDetailClientProps) {
    ...
    <div className="space-y-8 pb-16">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1 min-w-0 space-y-5">
          ...
          {/* Unavailable message */}
          {!isResolving && !canRead && (
            <div className="fixed-bottom flex items-start gap-3 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-200 dark:border-slate-700">
