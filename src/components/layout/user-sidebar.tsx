...
import { BookOpen, Home, Compass, Grid, Library, History, User, LogOut, X } from "lucide-react";
        ...
        <div className="flex items-center justify-between mb-8">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-slate-400 font-medium">Digital Library</span>
            </div>
          </Link>
          {onClose && (
            <button
